 ...
 */
public class RenameMdIndexHandler extends ChannelInboundHandlerAdapter {

    private RenamedMd renamedMd;
    private RespDto respDto;

    public RenameMdIndexHandler(RenamedMd renamedMd, RespDto respDto) {
        this.renamedMd = renamedMd;
    ...
    public void channelActive(ChannelHandlerContext ctx) {
        ...
        reqDto.setOpsContent(JSON.toJSONString(renamedMd));
